...
execute store result score #ds-banner ds-var run random value 1..10

# Change this to number of rares
execute store result score #ds-banner ds-reg1 run random value 1..15
execute store result score #ds-banner ds-reg2 run random value 1..14
