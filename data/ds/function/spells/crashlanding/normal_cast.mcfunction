...
# Set Sword Drop ID
scoreboard players add #ds-global ds-crashlanding-sworddrop-id 1
scoreboard players operation @s ds-crashlanding-sworddrop-id = #ds-global ds-crashlanding-sworddrop-id
scoreboard players operation @e[tag=fallingsword_location,sort=nearest,limit=1,distance=..30,tag=!spawned] ds-crashlanding-sworddrop-id = @s ds-crashlanding-sworddrop-id
