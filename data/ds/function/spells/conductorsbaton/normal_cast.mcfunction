...
execute as @e[distance=..5,tag=!conductors_baton_caster,type=!item] run damage @s 5 player_attack by @a[tag=conductors_baton_caster,limit=1,sort=nearest]
execute as @e[distance=..5,tag=!conductors_baton_caster,type=!item] run effect give @s blindness 1
